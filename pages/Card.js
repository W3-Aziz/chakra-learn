import { Badge, Box, Image, Stack, useColorMode, Text, Button, Icon } from "@chakra-ui/react"

const Card = () => {
    const { colorMode } = useColorMode()
    const bgColor = { light: 'gray.200', dark: 'grat.700' }
    ...
    return (
        <Box w='400px'
            ...
            overflow='hidden'
            boxShadow='sm'
            bg={bgColor[colorMode]} alignContent={'center'}>
